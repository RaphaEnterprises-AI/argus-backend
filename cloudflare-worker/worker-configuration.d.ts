/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 08e0a443d4c80545787b419ec93cd331)
// Runtime types generated with workerd@1.20251210.0 2025-09-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RealtimeSession";
	}
	interface Env {
		CACHE: KVNamespace;
		...
		DEFAULT_BACKEND: "vultr";
		BROWSER_POOL_URL: "http://65.20.72.251.nip.io";
		SELENIUM_GRID_URL: "http://65.20.71.218:4444";
		REALTIME: DurableObjectNamespace<import("./src/index").RealtimeSession>;
		ARTIFACTS: R2Bucket;
		EVENT_QUEUE: Queue;
		DLQ: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEFAULT_MODEL_PROVIDER" | "ENABLE_CACHING" | "ENABLE_SELF_HEALING" | "DEFAULT_BACKEND" | "BROWSER_POOL_URL" | "SELENIUM_GRID_URL">> {}
}
