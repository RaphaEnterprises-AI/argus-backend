/**
 * Skopaq - AI-Powered Browser Automation API
 * https://skopaq.ai
 *
...
async function createGitHubPR(
  ...
  const headers = {
    ...
    "User-Agent": "Skopaq-Quality-Intelligence",
    "Content-Type": "application/json",
  };
...
Generated by Skopaq Quality Intelligence Platform
...
${test.description}`,
    ...
    const createPRResponse = await fetch(
      `https://api.github.com/repos/${owner}/${repo}/pulls`,
      {
        ...
        headers,
        body: JSON.stringify({
          title: `[Skopaq] Add test: ${test.name}`,
          body: `## AI-Generated Test

This test was automatically generated by **Skopaq Quality Intelligence Platform** based on a production error.
...
---
*This PR was created automatically by [Skopaq](https://skopaq.ai). Please review the generated test before merging.*`,
          head: branchName,
          base: base_branch,
  ...
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    if (path === "/") {
      return Response.json({
        name: "Skopaq API",
        version: "2.1.0",
        description: "AI-powered browser automation and Quality Intelligence Platform - skopaq.ai",
        endpoints: {
          // Browser Automation
