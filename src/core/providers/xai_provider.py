...
class XAIProvider(BaseProvider):
    ...
    MODELS = {
        ...
        "grok-4-0709": ModelInfo(
            ...
            supports_streaming=True,
            tier=ModelTier.EXPERT,
            description="xAI's flagship Grok 4 model with deep reasoning and vision",
        ...
        "grok-4-fast-reasoning": ModelInfo(
            ...
            description="Fast reasoning variant of Grok 4 with 2M context window",
            aliases=[],
            release_date="2025-07",
        ),
        "grok-4-1-fast-reasoning": ModelInfo(
            ...
            supports_streaming=True,
            tier=ModelTier.STANDARD,
            description="Grok 4.1 fast reasoning with improved accuracy and 2M context",
            aliases=[],
            release_date="2025-07",
        ),
        "grok-code-fast-1": ModelInfo(
            ...
            supports_streaming=True,
            tier=ModelTier.STANDARD,
            description="Code-specialized Grok model optimized for fast code generation",
